...
export const AddReferRequest = ({ open, handleClose, getData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      // formData.append("relevant_it_experience", values.totalExp);
      // formData.append("candidate_linkedin", values.linedIn);
      // formData.append("referred_by", empName);
      // formData.append("referral_email", empEmail);
