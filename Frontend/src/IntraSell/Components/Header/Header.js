...
export const Header = () => {
  ...
  return (
    <div>
      {" "}
      <div className="intrasell-nav">
        <div className=" container d-flex  justify-content-between align-items-center">
          <div>
            <button
              className="intrasell-nav-btn d-flex d-md-none"
          ...
          <div>
            <div className="intrasell-nav-compo d-none d-md-flex align-items-center ">
              <div className="d-flex align-items-center ">
                {/* {NavData.filter((item) => {
                  if (role === "HR") {
                    ...
                    return (
                      item.title === "My Posts" || item.title === "Intrasell"
                    );
                  }
                }) */}
                {NavData.map((i, index) => {
