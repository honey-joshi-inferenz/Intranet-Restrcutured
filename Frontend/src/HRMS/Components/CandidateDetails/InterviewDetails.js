    ...
    <div className="mt-3 w-100 d-flex flex-column ">
      ...
      >
        ...
        <AccordionDetails>
          ...
          <div className="d-flex flex-md-row flex-column text-start">
            {filledData.resume_source === "Referral" && rejected && (
              <div
                className={
                  otherReason
                    ? "col-12 col-md-6 me-0 me-md-2 mb-3"
                    : "col-12 mb-3"
                }
              >
                <label className="form-label">
                  Referral Update for Employee
                </label>
                <textarea
                  type="text"
      ...
      >
        <AccordionSummary
          ...
          id="panel2-header"
        >
          <Typography className="fw-bold">Interview Details</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <div className="d-flex flex-md-row flex-column text-start mb-3">
            <div className="col-12 col-md-6 me-0 me-md-2">
      ...
      >
        <AccordionSummary
          ...
          id="panel3-header"
        >
          <Typography className="fw-bold">Joining Info</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <div className="d-flex flex-md-row flex-column text-start mb-3">
            <div className="col-12 col-md-6 me-0  me-md-2">
