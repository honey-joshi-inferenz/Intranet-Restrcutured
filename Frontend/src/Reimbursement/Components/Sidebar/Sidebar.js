...
export const Sidebar = () => {
  ...
  const { reimbursenavVisible, setReimburseNavVisible } =
  ...
  return (
    <div>
      <div className="reimburse-sidenav d-flex d-lg-none ">
        <div className=" container d-flex  justify-content-between align-items-center ">
          <div>
            <button
              className="reimburse-sidenav-btn d-flex d-lg-none"
              onClick={() => setReimburseNavVisible(!reimbursenavVisible)}
            >
              <MdMenu size={24} />
            </button>
          </div>
      ...
      <nav className={!reimbursenavVisible ? "sidenav" : ""}>
        <div>
          <div className="d-flex justify-content-between w-100">
            ...
            <div className="d-flex align-items-center">
              {reimbursenavVisible && <div className="sidenavLine" />}
              <div
                className={reimbursenavVisible ? "sidenav-btn " : "open-btn "}
                onClick={() => {
                  setReimburseNavVisible(!reimbursenavVisible);
                }}
              ></div>
            </div>
          </div>
