...
export const HREditRequest = () => {
  ...
  return (
    <div className="hrEditRequest w-100 d-flex flex-column">
      <Header />
      {Object.keys(data)?.length > 0 ? (
        <div className="pt-3 w-100 mt-5  d-flex align-items-center justify-content-center container flex-column ">
          <div className="hrEditRequestCompo w-100 card p-3 mt-3 pb-0">
            <div className="hrEditRequestEmpData d-flex justify-content-md-between flex-md-row flex-column">
                ...
                <div aria-label="breadcrumb" className="breadcrumbs">
                  <ol className="breadcrumb">
                    <li className="breadcrumb-item">
                      <Link to="/reimbursement-home" className="link">
                        Home
                      </Link>
                    </li>
              ...
              <div className="d-flex empData align-items-center ">
                <div className=" text-start text-md-end  d-flex flex-column">
                  <div>
                    <span
                  ...
                  <div className="w-100 d-flex mt-3 flex-md-row flex-column">
                    <div className="d-flex flex-lg-row flex-column align-items-center empDetails">
                      <div className="d-flex flex-row align-items-center me-0 me-lg-3">
                        ...
                        <span className="text-end ms-2">{data?.emp_code}</span>
                      </div>
                      <div className="d-flex flex-row align-items-center me-0 me-lg-3">
                      ...
                      <div className="d-flex flex-row align-items-center">
                        ...
                        <span className="text-end ms-2">{data?.dept_name}</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <TabContext value={stage}>
            <Box className="w-100 card hrEditTabpanel">
            ...
            <TabPanel value="1" className="w-100">
              <div className="mt-3 card ">
                ...
                <div className="p-4 empExpenseOverview">
                  ...
                  <div className="row text-start mb-4">
                    <span className="col-md-4 expenseTitle">Expense Date</span>
                    <span className="col-md-8">
                  ...
                  <div className="row text-start mb-4">
                    <span className="col-md-4 expenseTitle">Paid Amount</span>
                    <span className="col-md-8">
                      ₹ &nbsp;
                  ...
                  <div className="row text-start mb-4">
                    <span className="col-md-4 expenseTitle">Payment Mode</span>
                    ...
                    {(data.status === "Rejected" ||
                      ...
                      <div className="row mt-4 lastUpdate">
                        <div className="col">
                          <h6>Reason</h6>
                          <span>
                            {data.status === "On Hold" && data.hr_reason_onhold
                      ...
                      <div className="col text-end">
                        ...
                        <span>
                          {data.hr_approved_date === "Pending"
                            ? "Pending"
                            : moment(new Date(data.hr_approved_date)).format(
                                "DD-MM-YYYY"
                              )}
                        </span>
                      </div>
                      ...
                      <div className="col text-end">
                        ...
                        <span>
                          {data.admin_approved_date === "Pending"
                            ? "Pending"
                            : moment(new Date(data.admin_approved_date)).format(
                                "DD-MM-YYYY"
                              )}
                        </span>
                      </div>
