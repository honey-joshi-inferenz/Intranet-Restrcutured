...
import { AddRequest } from "../../../Components/Requests/AddRequest/AddRequest";
...
export const HRRequests = () => {
  ...
  return (
    <div className="hrRequest w-100 d-flex flex-column">
      <Header />
      <div className="pt-3 w-100 mt-5  d-flex align-items-center justify-content-center container">
        {data?.length === 0 ? (
          ...
          <div className="pt-3 w-100 mt-3  d-flex align-items-center justify-content-center container flex-column ">
            <h4
            ...
            <div className="hrRequestCompo w-100 card p-3 mt-3">
              <div className="d-flex justify-content-lg-between flex-lg-row flex-column w-100">
